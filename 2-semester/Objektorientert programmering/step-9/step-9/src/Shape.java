...
public abstract class Shape implements Movable { // Implement Movable so the subclasses can use to move the object
     ...
     * So all subclasses (os Shape) must implement getArea (or be abstract and
     * delegate
