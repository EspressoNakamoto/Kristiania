...
public class Square extends Rectangle {
     ...
     * Notice how we use side as both width and length when we call the parent
     * constructor.
     */

    // We add the points to the constructor for top left and bottom right that we
    // extend from Rectangle
    ...
    public double getSide() {
        /*
         * We inherit from parent class (Rectangle), and as all sides in a square have
         * the same
         * length, we can return either length or width inherited from parent.
         * That is nice! We do not need a field for side in Square:)
         * But as the fields in the parent are private, we may not access the fields
         * directly.
         * But the getters (getLength and getWidth) are public, and therefore
         * accessible.
         */
    ...
    public void uniqueSquareMethod() {
        System.out.println("This is the unique method for Square.");
    }
}